...
import com.aiog.allinonegame.Pieces.Bishop;
import com.aiog.allinonegame.Pieces.King;
import com.aiog.allinonegame.Pieces.Knight;
import com.aiog.allinonegame.Pieces.Pawn;
import com.aiog.allinonegame.Pieces.Piece;
import com.aiog.allinonegame.Pieces.Queen;
import com.aiog.allinonegame.Pieces.Rook;
...
public class Chessgame extends AppCompatActivity implements View.OnClickListener {
    ...
    public Positions[][] Board = new Positions[8][8];
    public Positions[][] Board2 = new Positions[8][8];
    ...
    private void initializeBoard() {
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                Board[i][j] = new Positions(null);
                Board2[i][j] = new Positions(null);
            }
        }
    ...
    public void saveBoard() {
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                LastMoves.get(numberOfMoves - 1)[i][j] = new Positions(null);
            }
        }
    ...
    void setColorAtAllowedPosition(ArrayList<Coordinates> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (Board[list.get(i).getX()][list.get(i).getY()].getPiece() == null) {
                DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.drawable.highlight);
            } else {
